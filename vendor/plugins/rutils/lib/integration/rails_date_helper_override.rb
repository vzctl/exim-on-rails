...
#           select_day(datetime, options, html_options) + select_month(datetime, options, html_options) + select_year(datetime, options, html_options) +
#           select_hour(datetime, options, html_options) + select_minute(datetime, options, html_options)
#         end
#   end
# end #endif